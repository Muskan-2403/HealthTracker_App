 ...
 * Use the {@link ClientHealthDetails#newInstance} factory method to
...
public class ClientHealthDetails extends Fragment {
     ...
     * @return A new instance of fragment ClientHealthDetails.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ClientHealthFileAdpater cf = new ClientHealthFileAdpater(getContext());
        filesList.setAdapter(cf);
